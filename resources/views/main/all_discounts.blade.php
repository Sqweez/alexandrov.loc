	...
	<div class="wrap">
		...
		<div class="card">
			...
			<div class="card__body">
				...
				<a class="c_desc__item" href="{{route('all_discounts.show', ['discount' => $discount->id])}}">
					<div class="_rate">{{ $discount->discount_percent }}%</div>
					<span class="c_desc__item_img"><img src="{{asset('images/m_desc/' . $discount->discount_image)}}" alt=""></span>
					<h4>{{$discount->discount_name}}</h4>
